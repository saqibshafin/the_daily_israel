...
void main() {
  ...
  group('TheDailyIsraelApiClient', () {
    late http.Client httpClient;
    late TheDailyIsraelApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = TheDailyIsraelApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = TheDailyIsraelApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => TheDailyIsraelApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = TheDailyIsraelApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws TheDailyIsraelApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<TheDailyIsraelApiMalformedResponse>()),
        );
      });

      test(
          'throws TheDailyIsraelApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<TheDailyIsraelApiRequestFailure>()
